...
- Priority-based routing and capability toggles

## [1.0.1] - 2026-06-30

### Changed

- Clarify that AI Router works with any WP7 AI provider via dynamic discovery
- Update architecture documentation for 1.0.0 refactoring
