...
> Works with WordPress 7.0-RC2, tested using WordPress [AI](https://wordpress.org/plugins/ai/). Tested text generation and image generation, using two separate [Azure OpenAI](https://github.com/soderlind/ai-provider-for-azure-openai) deployments (gpt-4.1 for text, gpt-image-1 for images).
