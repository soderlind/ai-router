...
final class ConfigurationRepository implements ConfigurationRepositoryInterface {
	...
	/**
	 * Connector sync utility.
	 *
	 * @var ConnectorSyncInterface
	 */
	private ConnectorSyncInterface $connector_sync;

	/**
	 * Constructor.
	 *
	 * @param ConnectorSyncInterface|null $connector_sync Optional connector sync utility.
	 */
	public function __construct( ?ConnectorSyncInterface $connector_sync = null ) {
		$this->connector_sync = $connector_sync ?? new ConnectorSync();
	}
	...
	public function sync_request_options( Configuration $config ): void {
		$this->connector_sync->sync_request_options( $config );
	}
